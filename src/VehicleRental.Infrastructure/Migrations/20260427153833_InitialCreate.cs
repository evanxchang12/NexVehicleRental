    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "VehicleTypes",
                columns: new[] { "Id", "DailyRate", "Description", "ImageUrl", "IsAvailable", "Name" },
                values: new object[,]
                {
                    { 1, 1800m, "舒適四門轎車，適合商務出行", null, true, "Toyota Camry 2024" },
                    { 2, 2200m, "時尚休旅車，空間寬敞", null, true, "Mazda CX-5 2024" },
                    { 3, 3500m, "豪華性能轎車，駕駛快感十足", null, true, "BMW 3 Series 2024" },
                    { 4, 2500m, "商用廂型車，載貨載人皆宜", null, true, "Toyota Hiace Van" }
                });
